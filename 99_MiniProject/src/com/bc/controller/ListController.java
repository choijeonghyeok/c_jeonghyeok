...
public class ListController extends HttpServlet {
	...
	private void process(HttpServletRequest request, HttpServletResponse response) 
		...
		*/
		...
		//1. 전체 게시물의 수를 구하기
		System.out.println("DAO.getTotalCount1(): " + DAO.getTotalCount1());
		p.setTotalRecord(DAO.getTotalCount1());
		p.setTotalPage();
		...
		*/
		...
		List<CustomerVO> list1 = DAO.getList1(map); 
		System.out.println("> 현재페이지 글목록(list): " + list1);
