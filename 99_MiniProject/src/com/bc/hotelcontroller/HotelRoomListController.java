...
public class HotelRoomListController extends HttpServlet {
	...
	private void process(HttpServletRequest request, HttpServletResponse response) 
		...
		*/
		...
		//1. 전체 게시물의 수를 구하기
		p.setTotalRecord(DAO.getTotalCount4());
		p.setTotalPage();
		...
		*/
		...
		List<RoomVO> list4 = DAO.getList4(map); 
		System.out.println("> 현재페이지 글목록(list4): " + list4);
		...
		request.getRequestDispatcher("hotelroomlist.jsp").forward(request, response);
