...
public class QnaListController extends HttpServlet {
   ...
   private void process(HttpServletRequest request, HttpServletResponse response) 
      ...
      System.out.println(">>> DB에서 데이터 가져와서 qnalist.jsp로 전달");
      ...
      /*현재 페이지에 표시할 데이터를 화면에 표시 
		...
		*/
		...
		//1. 전체 게시물의 수를 구하기
		System.out.println("DAO.getTotalCount5(): " + DAO.getTotalCount5());
		p.setTotalRecord(DAO.getTotalCount5());
		p.setTotalPage();
		...
		*/
		...
		List<QnA_VO> list5 = DAO.getList5(map); 
		System.out.println("> 현재페이지 글목록(list): " + list5);
