...
public class ReserveController extends HttpServlet {
	...
	private void process(HttpServletRequest request, HttpServletResponse response) 
		...
		System.out.println(">>> DB에서 데이터 가져와서 reserve.jsp로 전달");
		...
		*/
		...
		//1. 전체 게시물의 수를 구하기
		System.out.println("DAO.getTotalCount2(): " + DAO.getTotalCount2());
		...
		*/
		...
		List<ReserveVO> list2 = DAO.getList2(map); 
		System.out.println("> 현재페이지 글목록(list2): " + list2);
		...
		//3. 페이지 전환 - 응답할 페이지(reserve.jsp)로 포워딩(전환)
